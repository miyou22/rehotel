      ...
      products: [
        {
          name: "디럭스룸",
          information:
            "2인 이하 여행객이 가장 선호하며, 여유로운 수납 공간과 Simmons Beautyrest® 의 킹 사이즈 침대 1조가 제공되는 객실입니다.침구는 100% 오리털, 100% 코튼 소재의 린넨으로 최상의 편안함을 경험할 수 있습니다.청정 제주의 감귤 추출물을 담은 킹스호텔의 특별한 감귤 어메니티를 만나 보세요.",
        ...
        },
        {
          name: "디럭스 풀",
          information:
            "가족 및 4인 이하 여행객이 가장 선호하며 여유로운 수납 공간과 Simmons Beautyrest®의퀸 사이즈 침대가 2조 제공되는 객실입니다. 100% 오리털 침구와 100% 코튼소재의 린넨은 최상의 편안함을 경험할 수 있습니다.청정 제주의 감귤 추출물을 담은 킹스호텔의 특별한 감귤 어메니티를 만나 보세요.",
        ...
        },
        {
          name: "그랜드 디럭스",
          information:
            "2인 이하 프리미엄을 선호하는 여행객에게 최선의 선택으로, 여유로운 수납 공간과 Simmons Beautyrest® 의킹 사이즈 침대 1조가 제공되는 객실입니다. 침구는 100% 오리털, 100% 코튼 소재의 린넨으로 최상의 편안함을 경험할 수 있습니다.청정 제주의 감귤 추출물을 담은 킹스호텔의 특별한 감귤 어메니티를 만나 보세요.",
